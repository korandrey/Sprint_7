...
//    успешный запрос возвращает ok: true;+
    ...
    public void duplicateCourierCannotBeCreated() {
        ...
        Assert.assertEquals("Вернулся неподходящий для автотеста код ответа", 409, duplicateStatusCode);
        ...
        Assert.assertEquals("Этот логин уже используется. Попробуйте другой.", messageForDuplicate);
    }
}
